...
This question asks whether the Digital Enggano Language Dictionary and the printed Enggano language dictionary been used in classroom learning. We invite the respondents to be honest if they have not used them. The results are shown in @fig-q13.
