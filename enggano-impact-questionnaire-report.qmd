...
It asks whether respondents are (i) teachers (in elementary school \[*SD*\], junior high school \[*SMP*\], or senior high school \[*SMA*\], or (ii) non-teachers (*BUKAN GURU*). Numbers in brackets are raw counts.
...
This question asks whether the Enggano language has ever been taught in class before the publication of the textbooks for Junior High and Elementary School.
...
The question asked whether the Enggano language subject is compulsory in the curriculum today. This question could also be interpreted by the respondents as Enggano should be a formally/regulated compulsory subject. There is an information that the local/district level government instructs for the teaching of the language at school but that has not been formalised as a written regulation.
...
We ask whether the textbooks for each school level (Junior High and Elementary levels) have ever been used in class since we released them in January 2025. We ask respondents to be honest if the books have never been used.
...
When in @sec-q3 the respondents answered "Yes" that they have used the textbooks in their classes, we asked them to rate (on the 5-point scale) how difficult it would be for the teacher to teach the material in the textbooks. The interpretation is the same, point 1 is very difficult and point 5 is very easy.
...
This question is a follow-up for the question in @sec-q10. It asks respondents to multi-choose from a pre-determined list, with an option to add "others", which parts they find difficult to teach.
